    ...
    <div class="row">
        ...
        <div class="conversation-wrap col-lg-3">
            ...
            <div class="media conversation">
                <a class="pull-left" href="#">
                    <img class="media-object" data-src="holder.js/64x64" alt="64x64" style="width: 50px; height: 50px;" src="img/employee.png">
                </a>
        ...
        <div class="message-wrap col-lg-8">
            <div class="msg-wrap">
                ...
                <div class="media msg ">
                    <a class="pull-left" href="#">
                        <img class="media-object" data-src="holder.js/64x64" alt="64x64" style="width: 32px; height: 32px;" src="img/employee.png">
                    </a>
                    <div class="media-body">
