        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="btn-panel btn-panel-conversation">
                    ...
                    <a href="" class="btn  col-lg-6  send-message-btn pull-right" role="button"><i
            ...
            <div class="col-lg-offset-1 col-lg-7">
                <div class="btn-panel btn-panel-msg">
                    ...
                    <a href="" class="btn  col-lg-3  send-message-btn pull-right" role="button"><i
                ...
                <div class="media conversation">
                    <a class="pull-left" href="#">
                        <img class="media-object" data-src="holder.js/64x64" alt="64x64"
                             style="width: 50px; height: 50px;" src="img/employee.png">
                    </a>
                    <div class="media-body">
                        <h5 class="media-heading">Valentin</h5>
                        <small>Hello</small>
                    </div>
                </div>
                <div class="media conversation">
            ...
            <div class="message-wrap col-lg-8">
                <div class="msg-wrap">
                    ...
                    <div class="media msg ">
                        <a class="pull-left" href="#">
                            <img class="media-object" data-src="holder.js/64x64" alt="64x64"
                                 style="width: 32px; height: 32px;" src="img/employee.png">
                        </a>
                        <div class="media-body">
                            <small class="pull-right time"><i class="fa fa-clock-o"></i> 12:10am</small>
                            <h5 class="media-heading">Valentin</h5>
                            <small class="col-lg-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
